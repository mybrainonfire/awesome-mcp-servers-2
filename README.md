...
- [Lodestar Stamp](https://lodestarstamp.com) - Dated public-source receipts agents fetch before they act via MCP (`https://api.lodestarindex.com/mcp` or `npx -y lodestar-stamp-mcp@0.1.8`). Facts on the record. We do not approve the booking. Lookup free through 2026.
